            ...
            <div className="w-full flex flex-col items-center justify-center">
                <div className="border border-slate-200 bg-slate-100 rounded-2xl shadow-xl p-6 text-center h-fit w-80 mt-2 flex flex-col items-center justify-center space-y-4">
                    ...
                    <p className="text-sm font-normal text-gray-700 text-left">
                        My name is {user?.profiles?.username} and i usually give
                ...
                <div className="mt-2">
                    <ScrollArea className="w-80 whitespace-nowrap rounded-md ">
                        <div className="flex w-max space-x-8 p-4">
                            <Popover>
                                <PopoverTrigger className="border-none bg-transparent w-fit h-fit">
                                    <Badge className="bg-green-400">
                                        <Trophy />
                                    </Badge>
                                </PopoverTrigger>
                                <PopoverContent className="ml-2">
                                    <h1 className="text-md font-semibold flex text-center">
                                    ...
                                    <p className="font-normal text-sm mt-2">
                                        You are in the top 5% of users who saved
                                        the most amount of food scraps from
                                        going to waste this month!{" "}
                                    </p>
                                </PopoverContent>
                            </Popover>
                            ...
                            <Popover>
                                ...
                                <PopoverContent className="ml-2">
                                    ...
                                    <p className="font-normal text-sm mt-2">
                                        You are in the top 1% most active users
                            ...
                            <Popover>
                                ...
                                <PopoverContent className="ml-2">
                                    ...
                                    <p className="font-normal text-sm mt-2">
                                        You have been contributing to a cleaner
                ...
                <div className="flex justify-content text-center items-center my-2 px-6 ">
                    <div className="px-3">
                        ...
                        <p className="text-sm text-gray-400">
                            of food scraps redirected from landfills
                        </p>
                    </div>
                    <div className="px-4">
