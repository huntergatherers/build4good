        ...
        >
            ...
            <div>
                <div className="flex space-x-2 items-center mb-2">
                    <div className="h-8 w-8 rounded-full relative border-gray-800">
                        <Image className="rounded-full object-cover border-gray-800" src={ProfilePic} alt="profile image" fill/>
                    </div>
                    <h1>
            ...
            {showDescription && (
                <div className="font-light text-sm line-clamp-2 w-36 mb-1 text-left h-6">
                    {listing.body}
                </div>
            )}
            <Progress
