...
export default function Tabs() {
  ...
  const getCreateColor = (path: string) =>
    pathname === path ? (
      <Plus color="white" size={18} fill="white" className="rounded-3xl" />
    ) : (
      <Plus color="white" size={18} fill="white" className="rounded-3xl" />
    );
        ...
        <div className="flex">
          <Link href="/listings" className="flex-1 flex justify-center">
            <div className="flex flex-col items-center justify-center">
              ...
              <span
                className={` ${getIconColor('/listings')} text-xs font-medium`}
              >
                Home
              </span>
            </div>
          ...
          <Link href="/community" className="flex-1 flex justify-center">
            <div className="flex flex-col items-center justify-center">
              ...
              <span
                className={` ${getIconColor('/community')} text-xs font-medium`}
              >
                Community
              </span>
            </div>
          ...
          <Link href="/chat" className="flex-1 flex justify-center">
            <div className="flex flex-col items-center justify-center">
              {getChatColor('/chat')}
              <span className={` ${getIconColor('/chat')} text-xs font-medium`}>
                Chat
              </span>
            </div>
          </Link>
          <Link href="/profile" className="flex-1 flex justify-center">
            <div className="flex flex-col items-center justify-center">
              ...
              <span
                className={` ${getIconColor('/profile')} text-xs font-medium`}
              >
                Profile
              </span>
            </div>
